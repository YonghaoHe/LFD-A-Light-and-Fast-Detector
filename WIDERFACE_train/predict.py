...
from WIDERFACE_train.WIDERFACE_LFD_v2_work_dir_20201214_110942.WIDERFACE_LFD_v2 import config_dict, prepare_model


prepare_model()

param_file_path = '../WIDERFACE_train/WIDERFACE_LFD_v2_work_dir_20201214_110942/epoch_300.pth'

load_checkpoint(config_dict['model'], load_path=param_file_path, strict=True)

image_path = '../debug_images/WIDERFACE/worlds-largest-selfie1.jpg'
