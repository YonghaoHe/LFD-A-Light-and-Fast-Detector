...
from TL_augmentation_pipeline import train_pipeline, val_pipeline
...
def prepare_model():
    ...
    classification_loss = QualityFocalLoss(
        use_sigmoid=True,
        beta=2.0,
        reduction='mean',
        loss_weight=1.0
    ...
    lfd_backbone = LFDResNet(
        ...
        stem_channels=48,
        body_architecture=[4, 2, 1, 1, 1],
        body_channels=[48, 64, 64, 128, 128],
        out_indices=((0, 3), (1, 1), (2, 0), (3, 0), (4, 0)),
        frozen_stages=-1,
...
def prepare_data_pipeline():
    ...
    config_dict['train_dataset_path'] = '....'
