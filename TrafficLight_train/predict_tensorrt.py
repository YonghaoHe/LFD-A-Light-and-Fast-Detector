...
precision_mode = 'int8'  # CAUTION: if the input size is large, say 2048x2048, it is very likely that the calibration may failed due to out of memory
max_workspace_size = GB(6)
min_timing_iterations = 2
avg_timing_iterations = 2

int8_calibrator = None
image_root_for_int8_calibration = '/home/yonghaohe/datasets/TT100K/data/int8_caliration'
...
for bbox in results:
    ...
    cv2.putText(image, category_name, (int(bbox[2] - 0), int(bbox[3] - 10)), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
