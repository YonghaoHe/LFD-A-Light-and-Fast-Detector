...
from WIDERFACE_train.WIDERFACE_LFD_XS_FPN_work_dir_20210123_105037.WIDERFACE_LFD_XS_FPN import config_dict, prepare_model


prepare_model()

param_file_path = './WIDERFACE_LFD_XS_FPN_work_dir_20210123_105037/epoch_500.pth'
